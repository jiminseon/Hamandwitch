...
function scene:create( event )
	...
	local bg = display.newImage("image/clear3-2.png")
	bg.x = display.contentCenterX
	bg.y = display.contentCenterY - 75
	sceneGroup:insert(bg)

	local nextSt = display.newImage("image/gotoEnding.png")
	...
	local function nextStage(event)
		...
		composer.setVariable("clear7", clearStage)
		composer.gotoScene("ending_1", options)
	end
