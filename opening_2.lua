...
function scene:create( event )
	...
	local background = display.newImage("image/opening2.png")
	...
	local story = display.newText("그런데 어느 날", display.contentCenterX , display.contentCenterY + 370,textbox.x + 80, 300, "font/BMJUA_ttf.ttf")
