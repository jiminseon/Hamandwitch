...
function scene:create( event )
	...
	local doorSound = audio.loadSound("music/door.mp3")
	audio.play(doorSound)

	local background = display.newImage("image/ending_2.png")
	...
	local story = display.newText("분명 이 근처에 있을 텐데…", display.contentCenterX , display.contentCenterY + 370,textbox.x + 80, 300, "font/BMJUA_ttf.ttf")
	story:setFillColor(0.3)
	story.size = 40
	sceneGroup:insert(story)

	local function Next(event)
		composer.gotoScene("ending_3")
	end
