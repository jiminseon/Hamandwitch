...
function scene:create( event )
	...
	local background = display.newImage("image/opening9.png")
	...
	local story = display.newText("그렇게 마녀가 외출한 어느 낮,\n햄스터 치치의 귀여운 모험이 시작되었습니다."
		, display.contentCenterX , display.contentCenterY + 370,textbox.x + 80, 300, "font/BMJUA_ttf.ttf")
	...
	local function Next(event)
		composer.gotoScene("stageExplain", options)
	end
