...
function scene:create( event )
	...
	local background = display.newImage("image/ending_3.png")
	...
	local story = display.newText("찾았다..! 진짜 보물상자야..!", display.contentCenterX , display.contentCenterY + 370,textbox.x + 80, 300, "font/BMJUA_ttf.ttf")
	story:setFillColor(0.3)
	story.size = 40
	sceneGroup:insert(story)

	local function Next(event)
		composer.gotoScene("ending_4")
	end
