...
function scene:create( event )
	...
	local background = display.newImage("image/ending_1.png")
	...
	local story = display.newText("이 문만 지나가면 드디어 보물이 있는 방이 나오는거야..!!", display.contentCenterX , display.contentCenterY + 370,textbox.x + 80, 300, "font/BMJUA_ttf.ttf")
	story:setFillColor(0.3)
	story.size = 40
	sceneGroup:insert(story)

	local function Next(event)
		composer.removeScene("ending_1")
		composer.gotoScene("ending_2")
	end
