...
function scene:create( event )
	...
	local supriseSound = audio.loadSound("music/ddiyong.mp3")
	audio.play(supriseSound)
	...
	local background = display.newImage("image/ending_5_2.png")
	...
	local story = display.newText("....이게 뭐야!!", display.contentCenterX , display.contentCenterY + 370,textbox.x + 80, 300, "font/BMJUA_ttf.ttf")
