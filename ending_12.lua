...
function scene:create( event )
	...
	local paperSound = audio.loadSound("music/paper1.mp3")
	audio.play(paperSound)

	local background = display.newImage("image/ending_12.png")
